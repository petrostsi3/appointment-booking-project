...
PASSWORD_RESET_TIMEOUT = 1  # Hours
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'accounts.validators.PasswordReuseValidator',
    },
    {
        'NAME': 'accounts.validators.UsernamePasswordSimilarityValidator',
    },
    {
...
logging.getLogger('django.core.mail').setLevel(logging.INFO)
LOGGING = {
    'version': 1,
